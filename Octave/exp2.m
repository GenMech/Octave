clear
clc
printf('Gitesh Pareek (20514813120) \n\n')
disp('Dual Simplex Method Implementation')
disp('Maximize Z= 3x(1) + 2x(2) + x(3)')
disp('Subject to constraints:')
disp('4x(1) + x(2) + x(3) = 30')
disp('2x(1) + 3x(2) + x(3) <= 60')
disp('x(1) + 2x(2) + 3x(3) <= 40')
disp('x(1), x(2), x(3) >= 0')
disp(' ');
c = [3, 2, 1]';
A = [ 4, 1, 1;
